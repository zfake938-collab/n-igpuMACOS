...
bool ntel_shader_cache_lookup(NtelTranslationEngine *engine, uint64_t hash, uint8_t **out_bytecode, uint32_t *out_size);
bool ntel_shader_cache_store(NtelTranslationEngine *engine, uint64_t hash, const uint8_t *bytecode, uint32_t size);
